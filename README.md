...
**Build: 🟩 passing** (2021-01-17T00:23:11+01:00)
...
| `lpc`             | none                   | "**l**oad **p**rogram **c**ounter"  | Load the value of the program counter register `PC` into register `A`.                                                                                              |
...
| `lsc`             | none                   | "**l**oad **s**tack **c**ounter"    | Load the value of the stack counter register `SC` into register `A`.                                                                                                |
