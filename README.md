...
**Build: 🟩 passing** (2020-09-09T16:41:12Z)
...
| `jp`              | required               | "**j**ump **n**ositive"             | Jump to the specified program position if register `A` holds a positive value, otherwise perform no operation.                                                      |
